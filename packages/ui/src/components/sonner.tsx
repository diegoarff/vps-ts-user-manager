...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  // next-themes types its theme as string to allow custom values; sonner accepts
  // only the three built-ins, so anything else falls back to system.
  const theme =
  ...
  return (
    <Sonner
      ...
      style={
        // SAFETY: CSS custom properties are valid CSSProperties values; React's
        // type just doesn't model arbitrary `--*` keys.
        {
